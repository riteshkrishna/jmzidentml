...
public enum MzIdentMLElement {
    ...
    AnalysisSoftware                (true,  "/mzIdentML/AnalysisSoftwareList/AnalysisSoftware",                                                                                             true,  true,  AnalysisSoftware.class,               null,                                       null,                                           false,  null),
    ...
    BibliographicReference          (true,  "/mzIdentML/BibliographicReference",                                                                                                            true,  false, BibliographicReference.class,         null,                                       null,                                           false,  null),
    ...
    CV                              (true,  "/mzIdentML/cvList/cv",                                                                                                                         true,  true,  Cv.class,                             null,                                       null,                                           false,  null),
    CvList                          (true,  "/mzIdentML/cvList",                                                                                                                            false, false, CvList.class,                         null,                                       null,                                           false,  null),
    CvParam                         (false, null, /* multiple locations */                                                                                                                  true,  false, CvParam.class,                        null,                                       null,                                           true,   CvParamRefResolver.class),
