...
public enum MzIdentMLElement {
    ...
    FragmentArray                   ("FragmentArray",                   true,  "/MzIdentML/DataCollection/AnalysisData/SpectrumIdentificationList/SpectrumIdentificationResult/SpectrumIdentificationItem/Fragmentation/IonType/FragmentArray", false, false, FragmentArray.class,  null,                                       null,                                           true,   FragmentArrayRefResolver.class),
    ...
    InputSpectrumIdentifications    ("InputSpectrumIdentifications",    true,  "/MzIdentML/AnalysisCollection/ProteinDetection/InputSpectrumIdentifications",                                                                   false, false, InputSpectrumIdentifications.class,   null,                                       null,                                           true,   InputSpectrumIdentificationsRefResolver.class),
    ...
    ParentOrganization              ("Parent",                          true,  "/MzIdentML/AuditCollection/Organization/Parent",                                                                                                false, false, ParentOrganization.class,             null,                                       null,                                           true,   ParentOrganizationRefResolver.class),
    ...
    PeptideEvidence                 ("PeptideEvidence",                 true,  "/MzIdentML/SequenceCollection/PeptideEvidenceList/PeptideEvidence",                                                                             false, true,  PeptideEvidence.class,                PeptideEvidenceCvParam.class,               PeptideEvidenceUserParam.class,                 true,   PeptideEvidenceResolver.class),
    ...
    PeptideEvidenceRef              ("PeptideEvidenceRef",              true,  "/MzIdentML/DataCollection/AnalysisData/SpectrumIdentificationList/SpectrumIdentificationResult/SpectrumIdentificationItem/PeptideEvidenceRef",  false, false, PeptideEvidenceRef.class,             null,                                       null,                                           true,   PeptideEvidenceRefResolver.class),
    PeptideHypothesis               ("PeptideHypothesis",               true,  "/MzIdentML/DataCollection/AnalysisData/ProteinDetectionList/ProteinAmbiguityGroup/ProteinDetectionHypothesis/PeptideHypothesis",                false, false, PeptideHypothesis.class,              null,                                       null,                                           true,   PeptideHypothesisRefResolver.class),
    ...
    SearchDatabaseRef               ("SearchDatabaseRef",               true,  "/MzIdentML/AnalysisCollection/SpectrumIdentification/SearchDatabaseRef",                                                                        false, false, SearchDatabaseRef.class,              null,                                       null,                                           true,   SearchDatabaseRefResolver.class),
    ...
    SpectrumIdentificationItem      ("SpectrumIdentificationItem",      true,  "/MzIdentML/DataCollection/AnalysisData/SpectrumIdentificationList/SpectrumIdentificationResult/SpectrumIdentificationItem",                     false, true, SpectrumIdentificationItem.class,     SpectrumIdentificationItemCvParam.class,    SpectrumIdentificationItemUserParam.class,      true,   SpectrumIdentificationItemRefResolver.class),
    SpectrumIdentificationItemRef   ("SpectrumIdentificationItemRef",   true,  "/MzIdentML/DataCollection/AnalysisData/ProteinDetectionList/ProteinAmbiguityGroup/ProteinDetectionHypothesis/PeptideHypothesis/SpectrumIdentificationItemRef", false, false,  SpectrumIdentificationItemRef.class,  null,                       null,                                           true,   SpectrumIdentificationItemRefRefResolver.class),
    ...
    SubSample                       ("SubSample",                       true,  "/MzIdentML/AnalysisSampleCollection/Sample/SubSample",                                                                                          false, false, SubSample.class,                      null,                                       null,                                           true,   SubSampleRefResolver.class),
